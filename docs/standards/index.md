...
- [npm Projects And Packages Standard](npm-projects-and-packages.md) - npm package and project categories and package
  naming and publishability rules for Pentaho.
- [npm Repository Configuration Standard](npm-repository-configuration.md) - npm dependency repository and
  configuration policy for Pentaho projects.
- [npm CI And Publishing Standard](npm-ci-and-publishing.md) - CI dependency installation, authentication, and package
  publishing rules.

## Deprecated Or Superseded Concepts
